...
struct Mob : Actor {
	...
	// 获取手头容器
	VA getHands() {
		return VA(this) + 1520;		// IDA Mob::readAdditionalSaveData
	}
	// 获取地图信息
...
#pragma endregion
	...
	// 获取网络标识符
	VA getNetId() {
		return (VA)this + 2536;		// IDA ServerPlayer::setPermissions
	}
	// 获取背包
	...
	void updateInventory() {
		VA itm = (VA)this + 4592;				// IDA Player::drop
...
struct ItemStackBase {
	...
	VA uk;
public:
	bool getFromId(int id, short aux, char count) {
