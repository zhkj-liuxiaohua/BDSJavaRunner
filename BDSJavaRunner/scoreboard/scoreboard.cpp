...
bool setscoreboard(Player* p, std::string objname, int count) {
	...
	if (scoreid == (VA)SYM_POINT(VA, MSSYM_B1QA7INVALIDB1AE12ScoreboardIdB2AAA32U1B1AA1A)) {
		std::cout << u8"[JR] 未能找到玩家对应计分板，自动设置: " << objname << std::endl;
...
THook2(_JA_GETSCOREBOARDPTR,
	void*, MSSYM_B2QQE170ServerScoreboardB2AAA4QEAAB1AE24VCommandSoftEnumRegistryB2AAE16PEAVLevelStorageB3AAAA1Z, void* _this, void* a2, void* a3) {
