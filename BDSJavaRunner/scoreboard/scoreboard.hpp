...
extern bool setscoreboard(Player*, std::string, int);
...
struct Scoreboard {
	...
	VA addObjective(std::string x, std::string t) {
		std::string d = "dummy";
		VA pctr = SYMCALL(VA, MSSYM_MD5_8eb370d57e021c0f860d2b6c3fc26127,
			this, d);
		return SYMCALL(VA, MSSYM_MD5_728e0b1daa52b95dcfd71c1a8e706e34,
			this, x, t, pctr);
	}
